...
urlpatterns = [
    ...
    re_path(r'^Predict_Revenue_Type/$', remoteuser.Predict_Revenue_Type, name="Predict_Revenue_Type"),
    ...
    re_path(r'^View_Prediction_Of_Revenue_Type_Ratio/$', serviceprovider.View_Prediction_Of_Revenue_Type_Ratio, name="View_Prediction_Of_Revenue_Type_Ratio"),
    re_path(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    re_path(r'^View_Prediction_Of_Revenue_Type/$', serviceprovider.View_Prediction_Of_Revenue_Type, name="View_Prediction_Of_Revenue_Type"),
